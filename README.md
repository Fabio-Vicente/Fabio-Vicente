...
<details>
  ...
  <div align="center">
    <h3>
      Olá! Eu sou Fábio Vicente
      <img src=./assets/gifs/hello.gif alt=Hello width=35 />
    </h3>
    <img src=./assets/gifs/greetings_typing_portuguese.svg alt="Saudações digitadas" />
  </div>

  <!-- About me -->
  <h3>
    <img src=./assets/gifs/man_programming.gif alt="Man Programming" width=60>
    <b>Um pouco sobre mim</b>
  </h3>
  <img src=./assets/gifs/blinking_line.gif alt="Blinking line" />

  <img src=./assets/gifs/programming.gif alt=Programming width=25% align=right >
  Sou um entusiasta da tecnologia como ferramenta de transformação no mundo.
  <ul>
    <br/>
    <li>🌐 Desenvolvedor Web Full-Stack</li>
    <li>
      <a href=https://www.credly.com/badges/cd90c35c-e41f-41de-ad7c-9822f943be56/public_url>☁️ Certificado AWS Cloud Practitioner;</a>
    </li>
    <li>🔟 Mais de 10 anos escrevendo códigos e scripts;</li>
    <li>⚗️ Aprendendo um pouquinho sobre DevOps;</li>
    <li>🟣 Faixa roxa de Jiu-Jitsu.</li>
  </ul>
  <br/>
  <br/>
...
<details open>
  ...
  <div align="center">
    <h3>
      Hi there! I'm Fábio Vicente
      <img src=./assets/gifs/hello.gif alt=Hello width=35 />
    </h3>
    <img src=./assets/gifs/greetings_typing_english.svg alt="Typing greetings" />
  </div>
  ...
  <img src=./assets/gifs/programming.gif alt=Programming width=25% align=right >
  I'm a technology entusiast who see it like a gear of world change.
  <ul>
    <br/>
  ...
  <h4><li>Front-end Development:</li></h4>
  <a title=HTML href=#>
    <img src=./assets/thumbnails/stacks/html.svg alt=HTML width=50 />
  </a>
  <a title=CSS href=#>
  ...
  <h4><li>Back-end Development:</li></h4>
  <a title=Node href=#>
    <img src=./assets/thumbnails/stacks/node.svg alt=Node width=50 />
  </a>
  <a title=TS-Node href=#>
  ...
  <h4><li>Continuos Integration/Development:</li></h4>
  <a title=Docker href=#>
    <img src=./assets/thumbnails/stacks/docker.svg alt=Docker width=50 />
  </a>
  <a title="Docker Compose" href=#>
  ...
  <h4><li>Scripting Languages:</li></h4>
  <a title=Python href=#>
    <img src=./assets/thumbnails/stacks/python.svg alt=Python width=50 />
  </a>
  <a title=Bash href=#>
  ...
  <h4><li>Structuring Languages:</li></h4>
  <a title=C href=#>
    <img src=./assets/thumbnails/stacks/c.svg alt=C width=50 />
  </a>
  <a title=C++ href=#>
...
<!-- Stats -->
  ...
  <img src=https://github.com/Fabio-Vicente/Fabio-Vicente/blob/metrics/coding-habits.svg alt="Code habits" width=49% />
  <img src=https://github.com/Fabio-Vicente/Fabio-Vicente/blob/metrics/achievements.svg alt="Achievements" width=49% />
  <div align=center>
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset=https://github.com/Fabio-Vicente/Fabio-Vicente/blob/snake_commits/github-contribution-grid-snake-dark.svg />
